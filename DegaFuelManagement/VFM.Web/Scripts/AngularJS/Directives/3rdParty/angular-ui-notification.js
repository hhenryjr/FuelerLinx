...
angular.module('ui-notification').provider('Notification', function () {
    ...
    this.$get = ["$timeout", "$http", "$compile", "$templateCache", "$rootScope", "$injector", "$sce", "$q", "$window", function ($timeout, $http, $compile, $templateCache, $rootScope, $injector, $sce, $q, $window) {
        ...
        var notify = function (args, t) {
            ...
            args.model = args.model ? args.model : options.model;
            ...
            $http.get(args.template, { cache: $templateCache }).success(function (template) {
                ...
                var reposite = function () {
                    ...
                    for (var i = messageElements.length - 1; i >= 0; i--) {
                        ...
                        var elHeight = parseInt(children.length > 0 ? $(children[0]).height() : element[0].offsetHeight);
                        var elWidth = parseInt(children.length > 0 ? $(children[0]).width() : element[0].offsetWidth);
...
angular.module("ui-notification").run(["$templateCache", function ($templateCache) {
    $templateCache.put("angular-ui-notification.html",
        "<div class=\"ui-notification SmallBox fast\"><div class=\"foto\"><i class=\"fa fa-bell\"></i></div><h3 ng-show=\"title\" ng-bind-html=\"title\">Alert</h3><div class=\"texttoFoto message\"><p ng-bind-html=\"message\"></p></div>");
}]);

//<div class="SmallBox animated fadeInRight fast" style="top: 141px; background-color: rgb(83, 132, 175);">
//    <div class=\"foto\">
//        <i class=\"fa fa-bell\"></i>
//    </div>
//    <div class="textoFoto">
//        <span>Big Information box</span>
