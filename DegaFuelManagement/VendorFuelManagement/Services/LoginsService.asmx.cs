...
namespace VendorFuelManagement.Services
{
    ...
    public class LoginsService : VFMWebService
    {
        ...
        [WebMethod(EnableSession = true)]
        public Clients GetCurrentUserClient()
        {
            return Users.CurrentUser.Client;
        }

        [WebMethod(EnableSession = true)]
        public Logins GetLogin(int id)
        {
            return Logins.GetLogin(id);
        }

        //[WebMethod(EnableSession = true)]
        //public bool SendContactUsEmail(Dictionary<string, object> contactUsInfoObject)
        //{
        ...
        //[WebMethod(EnableSession = true)]
        //public Logins GetDetailedLoginsInformation(int Id)
        //{
        ...
        //[WebMethod(EnableSession = true)]
        //public List<Logins> GetListOfLogins()
        //{
